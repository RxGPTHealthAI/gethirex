...
const techTeam = [
  ...
  { name: "Jayanth Sai Srinivas", role: "GCP Lead & Cloud DevOps", img: jayanthImg,
    bio: "Cloud DevOps Engineer with 3+ years. Leads HireX's entire GCP ecosystem with advanced Kubernetes strategies for global scale.",
    education: "B.Tech Mechanical Engineering, Sai Ganapathi Engineering College" },
