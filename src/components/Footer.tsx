    ...
    <div className="container">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3">
            <li><a href="mailto:contact@hirexai.space" className="text-sm text-hirex-text2 no-underline hover:text-foreground transition-colors">📧 contact@hirexai.space</a></li>
      ...
      <div className="flex flex-wrap items-center gap-4 text-[13px] text-hirex-text2 mb-8 pb-6 border-b border-border">
        ...
        <a href="mailto:contact@hirexai.space" className="no-underline text-hirex-text2 hover:text-foreground transition-colors">✉️ contact@hirexai.space</a>
      </div>
      ...
      <div className="flex flex-wrap justify-between items-center text-[12px] text-hirex-text3 gap-4">
        ...
        <div className="flex gap-3">
          ...
          <a href="mailto:contact@hirexai.space" className="w-9 h-9 rounded-[10px] bg-hirex-surface border border-border flex items-center justify-center text-sm hover:bg-primary hover:border-primary transition-all no-underline text-foreground">✉</a>
        </div>
      </div>
    </div>
  </footer>
