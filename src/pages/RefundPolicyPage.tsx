  ...
  <div className="min-h-screen bg-background">
    ...
    <section className="max-w-4xl mx-auto px-6 pb-20 space-y-8">
      ...
      <div className="glass-card rounded-2xl p-8">
        ...
        <p className="text-sm text-muted-foreground mb-4">Email contact@hirexai.space with:</p>
        ...
        <div className="mt-4 flex items-center gap-2 text-sm text-primary">
          <Mail className="w-4 h-4" /> contact@hirexai.space — Response within 24 hours
        </div>
      </div>
    </section>
  </div>
