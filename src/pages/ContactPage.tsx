...
const ContactPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error("Could not send message. Please email us at contact@hirexai.space");
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-[60px] max-w-[1000px] mx-auto items-start">
            ...
            <div>
              ...
              <div className="flex flex-col gap-5 mb-9">
                {[
                  { icon: "✉", title: "Email Us", desc: <a href="mailto:contact@hirexai.space" className="text-primary-light text-sm no-underline">contact@hirexai.space</a> },
