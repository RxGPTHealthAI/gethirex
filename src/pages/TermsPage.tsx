  ...
  <div className="min-h-screen bg-background">
    ...
    <section className="max-w-4xl mx-auto px-6 pb-20 space-y-8">
      {[
        ...
        { title: "5. Payment Terms", content: "Payments processed via Stripe (international) and Razorpay (India). Plans auto-renew unless cancelled. Price changes: 30-day advance notice. Disputed charges: Contact support@gethirex.space within 30 days." },
