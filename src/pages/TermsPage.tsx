const TermsPage = () => (
  <div className="min-h-screen bg-background">
    ...
    <section className="max-w-4xl mx-auto px-6 pb-20 space-y-8">
      {[
        { title: "1. Eligibility & Accounts", content: "You must be 18+ to use HIREXAI. Employers must be legally registered businesses. Candidates must provide accurate profile information. One account per entity/individual. Sharing login credentials is prohibited." },
        ...
        { title: "4. Intellectual Property", content: "HIREXAI platform, AI models, agents, and algorithms are proprietary to GetHired Global Pvt Ltd. Your data remains yours. You grant HIREXAI a limited license to process your data to provide services." },
        { title: "5. Payment Terms", content: "Payments processed via Stripe (international) and Razorpay (India). Plans auto-renew unless cancelled. Price changes: 30-day advance notice. Disputed charges: Contact contact@hirexai.space within 30 days." },
        { title: "6. Limitation of Liability", content: "HIREXAI is not liable for: Hiring decisions made using AI recommendations, candidate misrepresentation, employer misrepresentation, third-party ATS/HRIS failures, or force majeure events. Maximum liability: 3 months of subscription fees paid." },
